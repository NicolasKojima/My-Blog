                ...
                <main class="flex flex-col md:flex-row flex-1 gap-4 p-4">
                    <div class="blog-post-grid">
                        <div class="flex-1 space-y-6">
                            <p class="header"> Blog Home / Highlights <p>
                            <article>
                                <div class="text-gray-700 post-b">
                                    <div class="blog-post-class1">
                                        <img src="{{ asset('storage/image/example-img-2.jpg') }}" alt="IMAGE" width="500" height="600">
                                    </div>
                                    <div></div>
                            ...
                            <div>
                                ...
                                <ul class="space-y-1 mt-2">
                                    ...
                                    <li class="category-menu">
                                        ...
                                        <a class="hover:underline" href="projectsblog">Project Blog</a>
                                    </li>
                                    <li class="category-menu">
                                        <img src="{{ asset('storage/icons/studies-icon.png') }}" alt="IMAGE" style="width: 20px; height:20px;">
